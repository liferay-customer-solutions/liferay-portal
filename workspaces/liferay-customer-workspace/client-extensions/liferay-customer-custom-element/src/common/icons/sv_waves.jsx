...
const SVWaves = () => (
    <svg width="370" height="369" viewBox="0 0 370 369" fill="none" xmlns="http://www.w3.org/2000/svg">
        <g clipPath="url(#clip0_4_9723)">
            ...
            <path d="M132.819 106.831C-117.002 160.678 123.509 523.161 278.681 506.599C433.874 490.092 569.985 238.477 455.144 112.415C340.226 -13.6747 288.671 74.2775 132.819 106.831Z" fill="url(#paint1_linear_4_9723)" />
        </g>
        <defs>
            <linearGradient id="paint0_linear_4_9723" x1="440.871" y1="8.1343" x2="88.314" y2="502.499" gradientUnits="userSpaceOnUse">
                <stop stopColor="white" stopOpacity="0.25" />
                <stop offset="0.64" stopColor="white" stopOpacity="0.08" />
                <stop offset="1" stopColor="white" stopOpacity="0" />
            </linearGradient>
            <linearGradient id="paint1_linear_4_9723" x1="508.804" y1="73.3333" x2="44.4629" y2="442.129" gradientUnits="userSpaceOnUse">
