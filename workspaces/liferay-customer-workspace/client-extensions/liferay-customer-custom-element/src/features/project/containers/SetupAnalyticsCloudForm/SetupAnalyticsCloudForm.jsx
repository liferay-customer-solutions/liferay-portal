	...
	return featureFlags.includes('LPS-159127') ? (
									...
									<ClayForm.Group className="pb-1">
										...
										<div className="ml-3">
											<ClayCheckbox
												...
												label={i18n
													.sub(
														'by-checking-this-box-and-clicking-next-below-i-as-an-authorized-representative-of-x-acknowledge-that-x-accepts-the-terms-and-conditions-and-privacy-policy-these-terms-will-govern-x-s-use-of-liferay-analytics-cloud-unless-x-has-entered-into-a-separate-agreement-with-liferay-that-governs-x-s-use-of-liferay-analytics-cloud',
														[project.name]
													)
													.replace(
														/\{0\}/g,
		...
		<Layout
			...
			footerProps={{
				...
				middleButton: (
					<Button
						disabled={baseButtonDisabled || !termAndConditionsChecked}
						displayType="primary"
						...
						<ClayForm.Group className="pb-1">
							...
							<div className="ml-3">
								<ClayCheckbox
									...
									label={i18n
										.sub(
											'by-checking-this-box-and-clicking-submit-below-i-as-an-authorized-representative-of-x-acknowledge-that-x-accepts-the-terms-and-conditions-and-privacy-policy-these-terms-will-govern-x-s-use-of-liferay-analytics-cloud-unless-x-has-entered-into-a-separate-agreement-with-liferay-that-governs-x-s-use-of-liferay-analytics-cloud',
											[project.name]
										)
										.replace(/\{0\}/g, project.name)}
									onChange={() =>
										setTermAndConditionsChecked(
											(
												previousTermAndConditionsChecked
