...
import useHasJiraAccount from '../../hooks/useHasJiraAccount';
...
const BusinessEventsAddPage: React.FC<IProps> = ({
	...
	const {hasAccount: hasJiraAccount, loading: loadingJiraAccountChecking} =
		useHasJiraAccount(project?.accountKey || '');
