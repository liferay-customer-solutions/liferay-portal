			...
			{!!tokenOrdersData?.items.length && (
				...
				>
					<ListView<PlacedOrder>
						...
						resource={`o/headless-commerce-delivery-order/v1.0/channels/${Liferay.CommerceContext.commerceChannelId}/accounts/${Liferay.CommerceContext.account?.accountId}/placed-orders?filter=${SearchBuilder.eq('orderTypeExternalReferenceCode', 'AI_HUB_TOKEN')}&nestedFields=placedOrderItems&sort=createDate:desc`}
						tableProps={{
							columns: [
								{
									id: 'createDate',
