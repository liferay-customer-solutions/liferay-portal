...
import FileList from '~/pages/TicketAttachments/components/FileList/FileList';
import CommentPostFailed from '~/pages/TicketAttachments/components/TicketAttachmentsMessages/CommentPostFailed';
import ServerUnavailable from '~/pages/TicketAttachments/components/TicketAttachmentsMessages/ServerUnavailable';
import UploadConfirmation from '~/pages/TicketAttachments/components/TicketAttachmentsMessages/UploadConfirmation';
import useCheckAttachmentAccess from '~/pages/TicketAttachments/hooks/useCheckAttachmentAccess';
import useGCSUploadFile from '~/pages/TicketAttachments/hooks/useGCSUploadFile';
...
const TicketAttachmentsUploader = ({
	setUploadStateData,
	uploadStateData,
}: IProps) => {
...
export default TicketAttachmentsUploader;
