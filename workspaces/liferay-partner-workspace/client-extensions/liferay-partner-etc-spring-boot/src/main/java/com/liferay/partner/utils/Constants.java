...
public class Constants {
	...
	public static final String CHANNEL_ACCOUNT_MANAGER =
		"Channel Account Manager (CAM)";

	public static final String CHANNEL_ENABLEMENT_MANAGER =
		"Channel Enablement Manager (CEM)";

	public static final String CHANNEL_FINANCE_MANAGER =
		"Channel Finance Manager (CFM)";

	public static final String CHANNEL_MARKETING_DIRECTOR =
		"Channel Marketing Director (CMD)";

	public static final String CHANNEL_MARKETING_MANAGER =
		"Channel Marketing Manager (CMM)";

	public static final String CHANNEL_OPERATIONS_MANAGER =
		"Channel Operations Manager (COM)";
